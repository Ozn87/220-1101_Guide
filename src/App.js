...
import core1 from './data/2201101.json'
...
function App() {
  ...
  return (
    <div>
      <h1 className="titles">Core-1 220-1101</h1>
      <h1 className="titles">SU Practice Guide</h1>
      <div className="app">
        {showExam ? (
          <>
            {showScore ? (
                    ...
                    <div className="quetion-skipper">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (parseInt(e.target.value) > 139) {
                            setCurrentQuestion(138)
                          }
                        }}
                      />
                    </div>
